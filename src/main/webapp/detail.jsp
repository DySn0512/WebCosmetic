...
<div class="breadcrumb">
    <a href="home">Home</a>
    <a href="home?category=${product.productCategory.name}&page=1">${product.productCategory.name}</a>
    <a href="home?subcategory=${product.subCategory.name}&page=1">${product.subCategory.name}</a>
        ...
        <div class="right">
            ...
            <form action="cart" method="post">
                ...
                <c:forEach items="${product.details}" var="detail">
                    <button type="button" class="select-detail"
                            onclick="selectDetail(${detail.sale}, ${detail.price}, ${detail.salePrice}, ${detail.id}, this) ">${detail.unit} </button>
                </c:forEach>
                <button class="CartBtn" value="add" name="action" onclick="checkSelect()">
                        <span class="IconContainer">
                          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"
                               fill="rgb(17, 17, 17)" class="cart"><path
